...
const Controller = (() => {
  ...
  setupEventListeners = () => {
    const { menu, navList,viewButton,fbFollowLink,twitterFollowLink,linkedinFollowLink,formSubmitButton } = DOMStrings;
    ...
    // Send mail
    document.querySelector(`.${formSubmitButton}`).addEventListener('click', sendEmail);
  };
